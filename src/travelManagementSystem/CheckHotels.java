...
public class CheckHotels extends JFrame implements Runnable{
	...
	public void run() {
		...
		String[] text = new String[] {"JW Marriot Hotel", "Madarin Original Hotel","Four Seasons Hotel", "Raddisson Blue Hotel", "Classsio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel","Happy Morning Motel","Riverview Hotel"};
